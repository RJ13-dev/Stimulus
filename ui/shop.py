...
A wooden "Exit to Lobby" button closes the shop; closing emits `closed`,
which the lobby connects to refresh its coin badge.
...
SHOP_ITEMS = [
    {"key": "skincare_kit",   "name": "Glow Essence Kit",   "price": 60,  "emoji": "\U0001f9f4", "effect": "clear_skin_glow"},
    {"key": "tumbler",        "name": "Floral Tumbler",     "price": 25,  "emoji": "\U0001f964", "effect": "hydrated_vibe"},
    {"key": "watch",          "name": "Rose Gold Watch",    "price": 120, "emoji": "\u231a", "effect": "elegant_wrist"},
    {"key": "makeup_palette", "name": "Pastel Makeup Set",  "price": 45,  "emoji": "\U0001f3a8", "effect": "rosy_cheeks"},
    {"key": "plushie",        "name": "Cuddly Bear Toy",    "price": 30,  "emoji": "\U0001f9f8", "effect": "plushie_on_bed"},
    {"key": "heels",          "name": "Starlight Shoes",    "price": 85,  "emoji": "\U0001f460", "effect": "fancy_footwear"},
    {"key": "gown",           "name": "Designer Gown",      "price": 250, "emoji": "\U0001f457", "effect": "gala_ready"},
    {"key": "perfume",        "name": "Luxury Perfume",     "price": 75,  "emoji": "\U0001fabb", "effect": "scent_trail"},
    {"key": "hair_clip",      "name": "Ribbon Bow Clip",    "price": 15,  "emoji": "\U0001f380", "effect": "perfect_hair"},
    {"key": "mirror",         "name": "Vanity Mirror",      "price": 55,  "emoji": "\U0001fa9e", "effect": "vanity_reflection"},
    {"key": "handbag",        "name": "Chic Mini Bag",      "price": 110, "emoji": "\U0001f45c", "effect": "stylish_walk"},
    {"key": "sunglasses",     "name": "Cat-Eye Glasses",    "price": 40,  "emoji": "\U0001f576", "effect": "cool_aesthetic"},
    {"key": "claw_clip",      "name": "Matte Claw Clip",    "price": 10,  "emoji": "\U0001f487", "effect": "cozy_updo"},
    {"key": "lip_oil",        "name": "Glossy Lip Oil",     "price": 20,  "emoji": "\U0001f484", "effect": "high_shine_smile"},
    ...
    {"key": "jewelry_box",    "name": "Velvet Jewelry Box", "price": 35,  "emoji": "\U0001f48d", "effect": "organized_sparkle"},
    {"key": "pj_set",         "name": "Satin Pajama Set",   "price": 50,  "emoji": "\U0001f45a", "effect": "sleepover_chic"},
    {"key": "scented_candle", "name": "Lavender Vanilla",   "price": 18,  "emoji": "\U0001f56f\ufe0f", "effect": "calming_aroma"},
    {"key": "headphones",     "name": "Pastel Headphones",  "price": 95,  "emoji": "\U0001f3a7", "effect": "lofi_beats_vibe"},
    {"key": "nail_kit",       "name": "Press-On Nail Kit",  "price": 28,  "emoji": "\U0001f485", "effect": "fresh_manicure"},
    {"key": "tote_bag",       "name": "Canvas Tote Bag",    "price": 20,  "emoji": "\U0001f6cd\ufe0f", "effect": "thrifting_ready"},
    {"key": "body_mist",      "name": "Berry Blush Mist",   "price": 24,  "emoji": "\u2728", "effect": "sparkling_aura"},
    {"key": "hair_dryer",     "name": "Blowout Styler",     "price": 150, "emoji": "\U0001f4a8", "effect": "salon_volume"},
]
...
class ShopScreen(QMainWindow):
    ...
    def _build(self):
        ...
        # wooden Exit-to-Lobby button (left of the coin badge)
        self.exit_btn = WoodenButton("Exit to Lobby", width=170, parent=root)
